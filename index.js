    ...
    if (interaction.isChatInputCommand()) {
        ...
        if (commandName == "echo") {
            ...
            embed.addFields(
                ...
                {
                    name: "Starting hand",
                    value: `Possible starting hand permutation: ${possibleMainHandCombinations.length
                        }\nPossible unique starting hand combination: ${new Set(possibleMainHandCombinations.map((h) => h.join(","))).size
                        }\n`,
                    inline: true,
                },
